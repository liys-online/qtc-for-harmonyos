/* config-msvc.h — manual config for MSVC (Windows).  */

#ifndef _MSC_VER
#warn "config-msvc.h shouldn't be included for your development environment."
#error "config-msvc.h is for MSVC only."
#endif
